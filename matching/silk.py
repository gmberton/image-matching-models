...
class SilkMatcher(BaseMatcher):
    ...
    def __init__(self, device="cpu", matcher_post_processing='ratio-test', matcher_thresh=0.8, **kwargs):
        ...
        assert matcher_post_processing in SilkMatcher.MATCHER_POSTPROCESS_OPTIONS, f'Matcher postprocessing must be one of {SilkMatcher.MATCHER_POSTPROCESS_OPTIONS}'
